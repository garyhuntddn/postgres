...
DESCR("equal");
DATA(insert OID =  6094 ( "="		   PGNSP PGUID b t t	6021	6021	16	6094 6519 int1eq eqsel eqjoinsel ));
DESCR("equal");
DATA(insert OID =  95 ( "<"		   PGNSP PGUID b f f	21	21	16 520 524 int2lt scalarltsel scalarltjoinsel ));
DESCR("less than");
DATA(insert OID =  6095 ( "<"		   PGNSP PGUID b f f	6021	6021	16 6520 6524 int1lt scalarltsel scalarltjoinsel ));
DESCR("less than");
...
DESCR("not equal");
DATA(insert OID = 6519 (  "<>"	   PGNSP PGUID b f f	6021	6021	16 6519	6094 int1ne neqsel neqjoinsel ));
DESCR("not equal");
DATA(insert OID = 520 (  ">"	   PGNSP PGUID b f f	21	21	16	95 522 int2gt scalargtsel scalargtjoinsel ));
DESCR("greater than");
DATA(insert OID = 6520 (  ">"	   PGNSP PGUID b f f	6021	6021	16	6095 6522 int1gt scalargtsel scalargtjoinsel ));
DESCR("greater than");
...
DESCR("less than or equal");
DATA(insert OID = 6522 (  "<="	   PGNSP PGUID b f f	6021	6021	16 6524 6520 int1le scalarltsel scalarltjoinsel ));
DESCR("less than or equal");
...
DESCR("greater than or equal");
DATA(insert OID = 6524 (  ">="	   PGNSP PGUID b f f 6021 6021 16 6522	6095 int1ge scalargtsel scalargtjoinsel ));
DESCR("greater than or equal");
...
DESCR("multiply");
DATA(insert OID = 6526 (  "*"	   PGNSP PGUID b f f 6021 6021 6021 6526	 0 int1mul - - ));
DESCR("multiply");
DATA(insert OID = 527 (  "/"	   PGNSP PGUID b f f	21	21	21	 0	 0 int2div - - ));
DESCR("divide");
DATA(insert OID = 6527 (  "/"	   PGNSP PGUID b f f 6021 6021 6021	 0	 0 int1div - - ));
DESCR("divide");
DATA(insert OID = 528 (  "/"	   PGNSP PGUID b f f	23	23	23	 0	 0 int4div - - ));
DESCR("divide");
DATA(insert OID = 529 (  "%"	   PGNSP PGUID b f f	21	21	21	 0	 0 int2mod - - ));
DESCR("modulus");
DATA(insert OID = 6529 (  "%"	   PGNSP PGUID b f f 6021 6021 6021	 0	 0 int2mod - - ));
DESCR("modulus");
...
DESCR("equal");
DATA(insert OID = 6532 (  "="	   PGNSP PGUID b t t	6021	23	16 6533 6538 int14eq eqsel eqjoinsel ));
DESCR("equal");
DATA(insert OID = 533 (  "="	   PGNSP PGUID b t t	23	21	16 532 539 int42eq eqsel eqjoinsel ));
DESCR("equal");
DATA(insert OID = 6533 (  "="	   PGNSP PGUID b t t	23	6021	16 6532 6539 int41eq eqsel eqjoinsel ));
DESCR("equal");
DATA(insert OID = 534 (  "<"	   PGNSP PGUID b f f	21	23	16 537 542 int24lt scalarltsel scalarltjoinsel ));
DESCR("less than");
DATA(insert OID = 6534 (  "<"	   PGNSP PGUID b f f	6021	23	16 6537 6542 int14lt scalarltsel scalarltjoinsel ));
DESCR("less than");
DATA(insert OID = 535 (  "<"	   PGNSP PGUID b f f	23	21	16 536 543 int42lt scalarltsel scalarltjoinsel ));
DESCR("less than");
DATA(insert OID = 6535 (  "<"	   PGNSP PGUID b f f	23	6021	16 6536 6543 int41lt scalarltsel scalarltjoinsel ));
DESCR("less than");
DATA(insert OID = 536 (  ">"	   PGNSP PGUID b f f	21	23	16 535 540 int24gt scalargtsel scalargtjoinsel ));
DESCR("greater than");
DATA(insert OID = 6536 (  ">"	   PGNSP PGUID b f f	6021	23	16 6535 6540 int14gt scalargtsel scalargtjoinsel ));
DESCR("greater than");
DATA(insert OID = 537 (  ">"	   PGNSP PGUID b f f	23	21	16 534 541 int42gt scalargtsel scalargtjoinsel ));
DESCR("greater than");
DATA(insert OID = 6537 (  ">"	   PGNSP PGUID b f f	23	6021	16 6534 6541 int41gt scalargtsel scalargtjoinsel ));
DESCR("greater than");
DATA(insert OID = 538 (  "<>"	   PGNSP PGUID b f f	21	23	16 539 532 int24ne neqsel neqjoinsel ));
DESCR("not equal");
DATA(insert OID = 6538 (  "<>"	   PGNSP PGUID b f f	6021	23	16 6539 6532 int14ne neqsel neqjoinsel ));
DESCR("not equal");
DATA(insert OID = 539 (  "<>"	   PGNSP PGUID b f f	23	21	16 538 533 int42ne neqsel neqjoinsel ));
DESCR("not equal");
DATA(insert OID = 6539 (  "<>"	   PGNSP PGUID b f f	23	6021	16 6538 6533 int41ne neqsel neqjoinsel ));
DESCR("not equal");
DATA(insert OID = 540 (  "<="	   PGNSP PGUID b f f	21	23	16 543 536 int24le scalarltsel scalarltjoinsel ));
DESCR("less than or equal");
DATA(insert OID = 6540 (  "<="	   PGNSP PGUID b f f	6021	23	16 6543 6536 int14le scalarltsel scalarltjoinsel ));
DESCR("less than or equal");
DATA(insert OID = 541 (  "<="	   PGNSP PGUID b f f	23	21	16 542 537 int42le scalarltsel scalarltjoinsel ));
DESCR("less than or equal");
DATA(insert OID = 6541 (  "<="	   PGNSP PGUID b f f	23	6021	16 6542 6537 int41le scalarltsel scalarltjoinsel ));
DESCR("less than or equal");
DATA(insert OID = 542 (  ">="	   PGNSP PGUID b f f	21	23	16 541 534 int24ge scalargtsel scalargtjoinsel ));
DESCR("greater than or equal");
DATA(insert OID = 6542 (  ">="	   PGNSP PGUID b f f	6021	23	16 6541 6534 int14ge scalargtsel scalargtjoinsel ));
DESCR("greater than or equal");
DATA(insert OID = 543 (  ">="	   PGNSP PGUID b f f	23	21	16 540 535 int42ge scalargtsel scalargtjoinsel ));
DESCR("greater than or equal");
DATA(insert OID = 6543 (  ">="	   PGNSP PGUID b f f	23	6021	16 6540 6535 int41ge scalargtsel scalargtjoinsel ));
DESCR("greater than or equal");
DATA(insert OID = 544 (  "*"	   PGNSP PGUID b f f	21	23	23 545	 0 int24mul - - ));
DESCR("multiply");
DATA(insert OID = 6544 (  "*"	   PGNSP PGUID b f f	6021	23	23 6545	 0 int14mul - - ));
DESCR("multiply");
DATA(insert OID = 545 (  "*"	   PGNSP PGUID b f f	23	21	23 544	 0 int42mul - - ));
DESCR("multiply");
DATA(insert OID = 6545 (  "*"	   PGNSP PGUID b f f	23	6021	23 6544	 0 int41mul - - ));
DESCR("multiply");
DATA(insert OID = 546 (  "/"	   PGNSP PGUID b f f	21	23	23	 0	 0 int24div - - ));
DESCR("divide");
DATA(insert OID = 6546 (  "/"	   PGNSP PGUID b f f	6021	23	23	 0	 0 int14div - - ));
DESCR("divide");
DATA(insert OID = 547 (  "/"	   PGNSP PGUID b f f	23	21	23	 0	 0 int42div - - ));
DESCR("divide");
DATA(insert OID = 6547 (  "/"	   PGNSP PGUID b f f	23	6021	23	 0	 0 int41div - - ));
DESCR("divide");
DATA(insert OID = 550 (  "+"	   PGNSP PGUID b f f	21	21	21 550	 0 int2pl - - ));
DESCR("add");
DATA(insert OID = 6550 (  "+"	   PGNSP PGUID b f f	6021	6021	6021 6550	 0 int1pl - - ));
DESCR("add");
DATA(insert OID = 551 (  "+"	   PGNSP PGUID b f f	23	23	23 551	 0 int4pl - - ));
DESCR("add");
DATA(insert OID = 552 (  "+"	   PGNSP PGUID b f f	21	23	23 553	 0 int24pl - - ));
DESCR("add");
DATA(insert OID = 6552 (  "+"	   PGNSP PGUID b f f	6021	23	23 553	 0 int14pl - - ));
DESCR("add");
DATA(insert OID = 553 (  "+"	   PGNSP PGUID b f f	23	21	23 552	 0 int42pl - - ));
DESCR("add");
DATA(insert OID = 6553 (  "+"	   PGNSP PGUID b f f	23	6021	23 6552	 0 int41pl - - ));
DESCR("add");
DATA(insert OID = 554 (  "-"	   PGNSP PGUID b f f	21	21	21	 0	 0 int2mi - - ));
DESCR("subtract");
DATA(insert OID = 6554 (  "-"	   PGNSP PGUID b f f	6021	6021	6021	 0	 0 int1mi - - ));
DESCR("subtract");
DATA(insert OID = 555 (  "-"	   PGNSP PGUID b f f	23	23	23	 0	 0 int4mi - - ));
DESCR("subtract");
DATA(insert OID = 556 (  "-"	   PGNSP PGUID b f f	21	23	23	 0	 0 int24mi - - ));
DESCR("subtract");
DATA(insert OID = 6556 (  "-"	   PGNSP PGUID b f f	6021	23	23	 0	 0 int14mi - - ));
DESCR("subtract");
DATA(insert OID = 557 (  "-"	   PGNSP PGUID b f f	23	21	23	 0	 0 int42mi - - ));
DESCR("subtract");
DATA(insert OID = 6557 (  "-"	   PGNSP PGUID b f f	23	6021	23	 0	 0 int41mi - - ));
DESCR("subtract");
DATA(insert OID = 558 (  "-"	   PGNSP PGUID l f f	 0	23	23	 0	 0 int4um - - ));
DESCR("negate");
DATA(insert OID = 559 (  "-"	   PGNSP PGUID l f f	 0	21	21	 0	 0 int2um - - ));
DESCR("negate");
DATA(insert OID = 6559 (  "-"	   PGNSP PGUID l f f	 0	6021	6021	 0	 0 int1um - - ));
DESCR("negate");
...
DESCR("absolute value");
DATA(insert OID = 6682 (  "@"	   PGNSP PGUID l f f	 0	6021	6021	 0	 0 int1abs - - ));
DESCR("absolute value");
...
DESCR("add");
DATA(insert OID = 6818 (  "+"	   PGNSP PGUID b f f	20 6021	20 822	 0 int81pl - - ));
DESCR("add");
DATA(insert OID = 819 (  "-"	   PGNSP PGUID b f f	20	21	20	 0	 0 int82mi - - ));
DESCR("subtract");
DATA(insert OID = 6819 (  "-"	   PGNSP PGUID b f f	20	6021	20	 0	 0 int81mi - - ));
DESCR("subtract");
DATA(insert OID = 820 (  "*"	   PGNSP PGUID b f f	20	21	20 824	 0 int82mul - - ));
DESCR("multiply");
DATA(insert OID = 6820 (  "*"	   PGNSP PGUID b f f	20	6021	20 824	 0 int81mul - - ));
DESCR("multiply");
DATA(insert OID = 821 (  "/"	   PGNSP PGUID b f f	20	21	20	 0	 0 int82div - - ));
DESCR("divide");
DATA(insert OID = 6821 (  "/"	   PGNSP PGUID b f f	20	6021	20	 0	 0 int81div - - ));
DESCR("divide");
DATA(insert OID = 822 (  "+"	   PGNSP PGUID b f f	21	20	20 818	 0 int28pl - - ));
DESCR("add");
DATA(insert OID = 6822 (  "+"	   PGNSP PGUID b f f	6021	20	20 818	 0 int18pl - - ));
DESCR("add");
DATA(insert OID = 823 (  "-"	   PGNSP PGUID b f f	21	20	20	 0	 0 int28mi - - ));
DESCR("subtract");
DATA(insert OID = 6823 (  "-"	   PGNSP PGUID b f f	6021	20	20	 0	 0 int18mi - - ));
DESCR("subtract");
DATA(insert OID = 824 (  "*"	   PGNSP PGUID b f f	21	20	20 820	 0 int28mul - - ));
DESCR("multiply");
DATA(insert OID = 6824 (  "*"	   PGNSP PGUID b f f	6021	20	20 820	 0 int18mul - - ));
DESCR("multiply");
DATA(insert OID = 825 (  "/"	   PGNSP PGUID b f f	21	20	20	 0	 0 int28div - - ));
DESCR("divide");
DATA(insert OID = 6825 (  "/"	   PGNSP PGUID b f f	6021	20	20	 0	 0 int18div - - ));
DESCR("divide");
...
DESCR("multiply");
DATA(insert OID = 6914 (  "*"	   PGNSP PGUID b f f	790  6021		790 918   0 cash_mul_int1 - - ));
DESCR("multiply");
DATA(insert OID = 915 (  "/"	   PGNSP PGUID b f f	790  21		790   0   0 cash_div_int2 - - ));
DESCR("divide");
DATA(insert OID = 6915 (  "/"	   PGNSP PGUID b f f	790  6021		790   0   0 cash_div_int1 - - ));
DESCR("divide");
...
DESCR("multiply");
DATA(insert OID = 6918 (  "*"	   PGNSP PGUID b f f	6021	790		790 6914   0 int1_mul_cash - - ));
DESCR("multiply");
...
DESCR("equal");
DATA(insert OID = 7862 ( "="	   PGNSP PGUID b t t	6021	20	16 7868  7863 int18eq eqsel eqjoinsel ));
DESCR("equal");
DATA(insert OID = 1863 ( "<>"	   PGNSP PGUID b f f	21	20	16 1869  1862 int28ne neqsel neqjoinsel ));
DESCR("not equal");
DATA(insert OID = 7863 ( "<>"	   PGNSP PGUID b f f	6021	20	16 7869  7862 int18ne neqsel neqjoinsel ));
DESCR("not equal");
DATA(insert OID = 1864 ( "<"	   PGNSP PGUID b f f	21	20	16 1871  1867 int28lt scalarltsel scalarltjoinsel ));
DESCR("less than");
DATA(insert OID = 7864 ( "<"	   PGNSP PGUID b f f	6021	20	16 7871  7867 int18lt scalarltsel scalarltjoinsel ));
DESCR("less than");
DATA(insert OID = 1865 ( ">"	   PGNSP PGUID b f f	21	20	16 1870  1866 int28gt scalargtsel scalargtjoinsel ));
DESCR("greater than");
DATA(insert OID = 7865 ( ">"	   PGNSP PGUID b f f	6021	20	16 7870  7866 int18gt scalargtsel scalargtjoinsel ));
DESCR("greater than");
DATA(insert OID = 1866 ( "<="	   PGNSP PGUID b f f	21	20	16 1873  1865 int28le scalarltsel scalarltjoinsel ));
DESCR("less than or equal");
DATA(insert OID = 7866 ( "<="	   PGNSP PGUID b f f	6021	20	16 7873  7865 int18le scalarltsel scalarltjoinsel ));
DESCR("less than or equal");
DATA(insert OID = 1867 ( ">="	   PGNSP PGUID b f f	21	20	16 1872  1864 int28ge scalargtsel scalargtjoinsel ));
DESCR("greater than or equal");
DATA(insert OID = 7867 ( ">="	   PGNSP PGUID b f f	6021	20	16 7872  7864 int18ge scalargtsel scalargtjoinsel ));
DESCR("greater than or equal");

DATA(insert OID = 1868 ( "="	   PGNSP PGUID b t t	20	21	16	1862 1869 int82eq eqsel eqjoinsel ));
DESCR("equal");
DATA(insert OID = 7868 ( "="	   PGNSP PGUID b t t	20	6021	16	7862 7869 int81eq eqsel eqjoinsel ));
DESCR("equal");
DATA(insert OID = 1869 ( "<>"	   PGNSP PGUID b f f	20	21	16	1863 1868 int82ne neqsel neqjoinsel ));
DESCR("not equal");
DATA(insert OID = 7869 ( "<>"	   PGNSP PGUID b f f	20	6021	16	7863 7868 int81ne neqsel neqjoinsel ));
DESCR("not equal");
DATA(insert OID = 1870 ( "<"	   PGNSP PGUID b f f	20	21	16	1865 1873 int82lt scalarltsel scalarltjoinsel ));
DESCR("less than");
DATA(insert OID = 7870 ( "<"	   PGNSP PGUID b f f	20	6021	16	7865 7873 int81lt scalarltsel scalarltjoinsel ));
DESCR("less than");
DATA(insert OID = 1871 ( ">"	   PGNSP PGUID b f f	20	21	16	1864 1872 int82gt scalargtsel scalargtjoinsel ));
DESCR("greater than");
DATA(insert OID = 7871 ( ">"	   PGNSP PGUID b f f	20	6021	16	7864 7872 int81gt scalargtsel scalargtjoinsel ));
DESCR("greater than");
DATA(insert OID = 1872 ( "<="	   PGNSP PGUID b f f	20	21	16	1867 1871 int82le scalarltsel scalarltjoinsel ));
DESCR("less than or equal");
DATA(insert OID = 7872 ( "<="	   PGNSP PGUID b f f	20	6021	16	7867 7871 int81le scalarltsel scalarltjoinsel ));
DESCR("less than or equal");
DATA(insert OID = 1873 ( ">="	   PGNSP PGUID b f f	20	21	16	1866 1870 int82ge scalargtsel scalargtjoinsel ));
DESCR("greater than or equal");
DATA(insert OID = 7873 ( ">="	   PGNSP PGUID b f f	20	6021	16	7866 7870 int81ge scalargtsel scalargtjoinsel ));
DESCR("greater than or equal");

DATA(insert OID = 1874 ( "&"	   PGNSP PGUID b f f	21	21	21	1874  0 int2and - - ));
DESCR("bitwise and");
DATA(insert OID = 7874 ( "&"	   PGNSP PGUID b f f	6021	6021	6021	7874  0 int1and - - ));
DESCR("bitwise and");
DATA(insert OID = 1875 ( "|"	   PGNSP PGUID b f f	21	21	21	1875  0 int2or - - ));
DESCR("bitwise or");
DATA(insert OID = 7875 ( "|"	   PGNSP PGUID b f f	6021	6021	6021	7875  0 int1or - - ));
DESCR("bitwise or");
DATA(insert OID = 1876 ( "#"	   PGNSP PGUID b f f	21	21	21	1876  0 int2xor - - ));
DESCR("bitwise exclusive or");
DATA(insert OID = 7876 ( "#"	   PGNSP PGUID b f f	6021	6021	6021	7876  0 int1xor - - ));
DESCR("bitwise exclusive or");
DATA(insert OID = 1877 ( "~"	   PGNSP PGUID l f f	 0	21	21	 0	  0 int2not - - ));
DESCR("bitwise not");
DATA(insert OID = 7877 ( "~"	   PGNSP PGUID l f f	 0	6021	6021	 0	  0 int1not - - ));
DESCR("bitwise not");
DATA(insert OID = 1878 ( "<<"	   PGNSP PGUID b f f	21	23	21	 0	  0 int2shl - - ));
DESCR("bitwise shift left");
DATA(insert OID = 7878 ( "<<"	   PGNSP PGUID b f f	6021	23	6021	 0	  0 int1shl - - ));
DESCR("bitwise shift left");
DATA(insert OID = 1879 ( ">>"	   PGNSP PGUID b f f	21	23	21	 0	  0 int2shr - - ));
DESCR("bitwise shift right");
DATA(insert OID = 7879 ( ">>"	   PGNSP PGUID b f f	6021	23	6021	 0	  0 int1shr - - ));
DESCR("bitwise shift right");
...
DESCR("unary plus");
DATA(insert OID = 7917 (  "+"	   PGNSP PGUID l f f	 0	6021	6021	0	0 int1up - - ));
DESCR("unary plus");
