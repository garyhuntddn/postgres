...
DATA(insert ( 8102	n 0 int1_avg_accum	int8_avg		int1_avg_accum	int1_avg_accum_inv	int8_avg	f f 0	1016	0	1016	0	"{0,0}" "{0,0}" ));
...
DATA(insert ( 8109	n 0 int1_sum		-				int1_avg_accum	int1_avg_accum_inv int2int4_sum f f 0	20		0	1016	0	_null_ "{0,0}" ));
...
DATA(insert ( 8720	n 0 int1_accum	numeric_var_pop		int1_accum		int1_accum_inv	numeric_var_pop f f 0	2281	128 2281	128 _null_ _null_ ));
...
DATA(insert ( 8643	n 0 int1_accum	numeric_var_samp	int1_accum		int1_accum_inv	numeric_var_samp f f 0	2281	128 2281	128 _null_ _null_ ));
...
DATA(insert ( 8150	n 0 int1_accum	numeric_var_samp	int1_accum		int1_accum_inv	numeric_var_samp f f 0	2281	128 2281	128 _null_ _null_ ));
...
DATA(insert ( 8726	n 0 int1_accum	numeric_stddev_pop		int1_accum	int1_accum_inv	numeric_stddev_pop	f f 0	2281	128 2281	128 _null_ _null_ ));
...
DATA(insert ( 8714	n 0 int1_accum	numeric_stddev_samp		int1_accum	int1_accum_inv	numeric_stddev_samp f f 0	2281	128 2281	128 _null_ _null_ ));
...
DATA(insert ( 8156	n 0 int1_accum	numeric_stddev_samp		int1_accum	int1_accum_inv	numeric_stddev_samp f f 0	2281	128 2281	128 _null_ _null_ ));
